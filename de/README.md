...
Seite: 9
Beschreibung: >-
  JavaScript ist eine hochentwickelte, interpretierte und dynamisch typisierte
  Programmiersprache, die hauptsächlich für die Webentwicklung verwendet wird.
  Sie gehört zu den drei zentralen Technologien, mit denen interaktive und
  dynamische Websites sowie Webanwendungen erstellt werden.
---
...
![Intro Page](<../.gitbook/assets/intro (1).png>)
...
* [_Serverseitiges JavaScript_](server-side/) ermöglicht den Zugriff auf Server, Datenbanken und Dateisysteme.
