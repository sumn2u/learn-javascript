...
pageNumber: 53
description: >-
  Les fonctions sont des blocs de code qui exécutent une tâche spécifique ou un
  ensemble de tâches. Ce sont des unités de code réutilisables qui peuvent être
  appelées et exécutées à tout moment dans un
layout: editorial
---
