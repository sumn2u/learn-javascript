...
pageNumber: 77
description: >-
  L'héritage fait référence à la capacité d'un objet (sous-classe) à hériter des
  propriétés et des méthodes d'un autre objet (super-classe). JavaScript prend
  en charge l'héritage prototypique, ce qui si
---
