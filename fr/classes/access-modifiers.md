...
pageNumber: 78
description: >-
  Les modificateurs d'accès contrôlent la visibilité et l'accessibilité des
  membres de la classe (propriétés et méthodes). public, private et protected
  sont les trois modificateurs d'accès utilisés dans
---
