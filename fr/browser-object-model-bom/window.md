...
pageNumber: 80
description: >-
  Window est un objet global qui représente la fenêtre ou l'onglet du navigateur
  dans lequel la page web en cours est chargée. L'objet window agit comme
  l'objet global pour le JavaScript côté client, ce
---
