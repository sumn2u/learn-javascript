...
chapter: 6
pageNumber: 47
description: 数组是数据的列表，是编程中的基础部分. 我们可以在数组中存储多种类型的数据。
---
...
在本章中，我们将探讨以下主题：
* [遍历 (For-Each)](./for-each.md)
* [索引 (Indices)](./indices.md)
* [连接 (Join)](./join.md)
* [长度 (Length)](./length.md)
* [映射 (Map)](./map.md)
* [弹出 (Pop)](./pop.md)
* [推入 (Push)](./push.md)
* [反转 (Reverse)](./reverse.md)
* [移除首元素 (Shift)](./shift.md)
* [切片 (Slice)](./slice.md)
* [排序 (Sort)](./sort.md)
* [展开 (Spread)](./spread.md)
* [添加首元素 (Unshift)](./unshift.md)
