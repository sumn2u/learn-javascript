...
- [Cadenas](strings/README.md)
  ...
  - [Reemplazar](strings/replace.md)
  - [Longitud](strings/length.md)
...
- [Lógica condicional](conditional/README.md)
  ...
  - [Concatenar](conditional/concatenate.md)
- [Matrices](arrays/README.md)
  - [Unshift (Desplazar)](arrays/unshift.md)
  - [Map (Mapa)](arrays/map.md)
  - [Spread (Propagar)](arrays/spread.md)
  - [Shift (Quitar de encima)](arrays/shift.md)
  - [Pop (Quitar)](arrays/pop.md)
  - [Join (Unir)](arrays/join.md)
  - [Length (Longitud)](arrays/length.md)
  - [Push (Agregar)](arrays/push.md)
  - [For Each (Por cada)](arrays/for-each.md)
  - [Sort (Ordenar)](arrays/sort.md)
...
- [Objetos](objects/README.md)
  - [Properties (Propiedades)](objects/properties.md)
  - [Mutable (Mudable)](objects/mutable.md)
  - [Reference (Referencia)](objects/reference.md)
  - [Prototype (Prototipo)](objects/prototype.md)
  - [Delete (Borrar)](objects/delete.md)
  - [Enumeration (Enumeración)](objects/enumeration.md)
- [Fecha y hora](date-and-time.md)
- [JSON](json.md)
- [Manejo de errores](error-handling/try...-catch.md)
...
- [Eventos](events.md)
- [Promise, async/await (Promesas y asincronía)](promise-async-await/promise.md)
