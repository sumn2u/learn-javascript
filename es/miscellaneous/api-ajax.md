...
pageNumber: 160
description: >-
  Este capítulo presenta el concepto de IPA (Interfaz de Programación de
  Aplicaciones) y demuestra su uso a través de AJAX (JavaScript asíncrono y
  XML). Aprenda a obtener datos de fuentes externas e int
---
