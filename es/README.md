...
pageNumber: 8
description: >-
  JavaScript es un lenguaje de programación de alto nivel, interpretado y de
  tipo dinámico que se utiliza principalmente para el desarrollo web. Es una de
  las tecnologías centrales utilizadas para crear
---
...
![Página de introducción](<../.gitbook/assets/intro (1).png>)
...
* [_JavaScript del lado del servidor_](server-side/) permite el acceso a servidores, bases de datos y sistemas de archivos.
