...
pageNumber: 99
description: >-
  window is a global object that represents the browser window or tab in which
  the current web page is loaded. The window object acts as the global object
  for client-side JavaScript, meaning that variab
---
