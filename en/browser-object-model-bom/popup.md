...
pageNumber: 100
description: >-
  Popups are small window that appears on top of main browser to provide
  information. It is used to show notifications, alerts, dialogs, login forms,
  or any other content that should appear temporarily
---
