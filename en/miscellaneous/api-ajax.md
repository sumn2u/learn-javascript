...
pageNumber: 129
description: >-
  This chapter introduces the concept of APIs (Application Programming
  Interfaces) and demonstrates their use through AJAX (Asynchronous JavaScript
  and XML). Learn how to fetch data from external source
---
