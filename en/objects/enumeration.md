...
pageNumber: 78
description: >-
  Enumeration refers to the process of iterating over the properties of an
  object and performing a certain action for each property. One way to enumerate
  the properties of an object is to use the `for-i
---
