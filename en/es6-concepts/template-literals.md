...
pageNumber: 251
description: >-
  Template literals, introduced in ES6 (ECMAScript 2015), offer a powerful way
  to create dynamic strings in JavaScript. They allow you to embed expressions
  directly within strings, making your code more
---
...
* `${expression}`: This is where you embed JavaScript expressions, [variables](../basics/variables.md), or [functions](../functions/), which are evaluated and included within the string.
